...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        LearningGoal: "daily_conversation" | "business" | "travel" | "exam" | "culture" | "work_interview" | "dating_first_impression" | "small_talk" | "requests_refusals" | "service_complaints" | "honorifics" | "other";
        /** MeResponse */
        MeResponse: {
            user: components["schemas"]["AuthUser"];
        ...
        ScenarioResponse: {
            ...
            /**
             * Title Ko
             * @description 목록 카드에 표시하는 한국어 제목
             */
            title_ko: string;
            /**
             * Title En
             * @description 목록 카드에 표시하는 영어 제목. 없으면 생략한다
             */
            ...
            /**
             * Communication Goal
             * @description 목록 카드에 표시하는 대화 연습 목표
             */
            ...
            /**
             * Difficulty
             * @description 화면에 표시할 난이도. 없으면 easy로 표시한다
             */
            difficulty?: string | null;
            /**
             * Estimated Minutes
             * @description 예상 연습 시간(분). 없으면 턴 수로 추정한다
             */
            estimated_minutes?: number | null;
            /**
             * Is Featured
             * @description 추천 시나리오 표시 여부
             */
            is_featured: boolean;
            /**
             * End Condition
